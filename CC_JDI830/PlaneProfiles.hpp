...
static const PlaneProfile PROFILE_A2A_COMANCHE = {
    ...
    .tit1    = {},                  // no TIT
    .tit2    = {},
    .ff      = { 0, 30, 0,         { {0, 1.5, TFT_RED}, {1.5, 30, TFT_GREEN} }, 2 },
    .fuelRem = { 0, 90, 0,         { {0, 10, TFT_RED}, {10, 90, TFT_GREEN} }, 2 },  // max patched from sim at runtime
...
static const PlaneProfile PROFILE_XCUB = {
    ...
    .tit1    = {},
    .tit2    = {},
    .ff      = { 0, 23, 0,        { {0, 0.1, TFT_RED}, {0.1, 23, TFT_GREEN} }, 2 },
